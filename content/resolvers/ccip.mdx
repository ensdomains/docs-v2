...
To test your gateway you can use the [ENS Manager App](https://ens.app/) or for a more detailed try using [enstate](https://enstate.rs/n/luc.willbreak.eth) and notice the `ccip_urls` field.
