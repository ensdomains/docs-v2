...
```tsx {{ title: 'Wagmi (React)', language: 'tsx', variant: 'wagmi', link: 'https://wagmi.sh/react/hooks/useEnsAvatar', stackblitz: 'https://stackblitz.com/edit/ens-wagmi-use-ens-avatar' }}
