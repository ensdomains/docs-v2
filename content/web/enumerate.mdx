...
Notable exceptions include [first-layer](/glossary#first-layer) [.eth names](/registry/eth), and [wrapped names](/subnames/wrapper),
...
The ENS Team has worked together closely with the graph to provide the [ENS Subgraph](https://thegraph.com/hosted-service/subgraph/ensdomains/ens). This subgraph indexes ENS name registrations & wrapping of names that are part of the [ETH Registrar](/registry/eth).
...
```tsx {{ title: 'GraphQL', language: 'gql', variant: 'gql', link: "https://thegraph.com/hosted-service/subgraph/ensdomains/ens" }}
{
