...
This makes it a more in-depth process to update a users records. At the time of writing we <b>do not recommend</b> setting a users records.
However tooling to do this effectively is in the works.
