...
`,P=o.ZP.div((({theme:e,$color:t,$size:r})=>o.iv`
  ...
  ${"left"===i?o.iv`
        ...
        `:o.iv`
          right: 0;
        `}
  `)),gt=o.ZP.button((({theme:e,$inner:t,$hasColor:r,$color:n,disabled:i})=>o.iv`
    align-items: center;
    cursor: pointer;
    display: flex;
    gap: ${e.space[4]};
    ...
    ${()=>{if(t&&!r)return o.iv`
          color: ${e.colors.textSecondary};
        `}}
  `)),ht=({items:e,setIsOpen:t,isOpen:r,width:o,inner:i,align:a,shortThrow:s,keepMenuOnTop:l,labelAlign:c,direction:d})=>n.createElement(ft,$(b({},{$opened:r,$inner:i,$align:a,$shortThrow:s,$labelAlign:c,$direction:d}),{style:{width:i||o&&parseInt(o)>100?`${o}px`:"150px",zIndex:l?100:void 0}}),e.map((e=>{if(n.isValidElement(e))return(({setIsOpen:e,item:t})=>{const r=n.useRef(null),o=n.cloneElement(t,$(b({},t.props),{ref:r})),i=n.useCallback((()=>{e(!1)}),[e]);return n.useEffect((()=>{const e=r.current;return null==e||e.addEventListener("click",i),()=>{null==e||e.removeEventListener("click",i)}}),[i,t]),o})({item:e,setIsOpen:t});const{color:r,value:o,label:a,onClick:s,disabled:l,as:c,wrapper:d}=e,u={$inner:i,$hasColor:!!r,$color:r,disabled:l,onClick:()=>{t(!1),null==s||s(o)},as:c,children:a};return d?d(n.createElement(gt,$(b({},u),{type:"button"})),o||a):n.createElement(gt,$(b({},u),{key:o||a,type:"button"}))}))),mt=o.ZP.button((({theme:e,$size:t,$open:r,$direction:n})=>o.iv`
    z-index: 10;
    display: flex;
    align-items: center;
  ...
  `));var Zr,Nr;(Nr=Zr||(Zr={})).ArrowUp="ArrowUp",Nr.ArrowDown="ArrowDown",Nr.Enter="Enter";const Br=(e,t,r)=>"string"===typeof r?r:(null==r?void 0:r[e])||t,Mr=(e,t,r)=>"number"===typeof r?r:(null==r?void 0:r[e])||t,_r=n.forwardRef(((e,t)=>{var r=e,{description:o,disabled:i,autocomplete:a=!1,createable:s=!1,createablePrefix:l="Add ",noSelectionMessage:d,direction:u="down",error:p,hideLabel:f,inline:g,id:h,label:m,labelSecondary:y,required:w,tabIndex:x=-1,width:k,onBlur:S,onChange:C,onFocus:P,onCreate:z,options:T,rows:A,emptyListMessage:O="No results",name:L,value:R,size:I="medium",padding:j,inputSize:F}=r,D=v(r,["description","disabled","autocomplete","createable","createablePrefix","noSelectionMessage","direction","error","hideLabel","inline","id","label","labelSecondary","required","tabIndex","width","onBlur","onChange","onFocus","onCreate","options","rows","emptyListMessage","name","value","size","padding","inputSize"]);const Z=n.useRef(null),N=t||Z,B=n.useRef(null),M=n.useRef(null),[_,H]=n.useState(""),[W,q]=n.useState(""),Y=s&&""!==W,G=s||a,[V]=n.useState(h||Sr()),[U,X]=n.useState("");n.useEffect((()=>{R!==U&&void 0!==R&&X(R)}),[R]);const K=(null==T?void 0:T.find((e=>e.value===U)))||null,J=(e,t)=>{if(!(null==e?void 0:e.disabled))if((null==e?void 0:e.value)===Er)z&&z(W);else if((null==e?void 0:e.value)&&(X(null==e?void 0:e.value),t)){const r=t.nativeEvent||t,n=new r.constructor(r.type,r);Object.defineProperties(n,{target:{writable:!0,value:{value:e.value,name:L}},currentTarget:{writable:!0,value:{value:e.value,name:L}}}),C&&C(n)}},Q=n.useMemo((()=>{if(!G||""===W)return T;const e=W.trim().toLowerCase(),{options:t,exactMatch:r}=(Array.isArray(T)?T:[T]).reduce((e=>(t,r)=>{if(r.label){const n=r.label.trim().toLowerCase();-1!==n.indexOf(e)&&t.options.push(r),n===e&&(t.exactMatch=!0)}return t})(e),{options:[],exactMatch:!1});return[...t,...Y&&!r?[{label:`${l}"${W}"`,value:Er}]:[]]}),[T,Y,G,W,l]),[ee,te]=n.useState(-1),re=n.useCallback((e=>{const t=Q[e];if(t&&!t.disabled&&t.value!==Er)return te(e),void H(t.label||"");H(W),te(e)}),[Q,W,H,te]),ne=e=>{var t;let r=ee;do{if("previous"===e?r--:r++,r<0)return re(-1);if(Q[r]&&!(null==(t=Q[r])?void 0:t.disabled))return re(r)}while(Q[r])},[oe,ie]=n.useState(!1),ae=!i&&oe,se=""!==W&&G,le=Mr("min",4,F),ce=Mr("max",20,F),de=Math.min(Math.max(le,W.length),ce),[ue,pe]=c({timeout:{enter:0,exit:300},preEnter:!0});(0,n.useEffect)((()=>{pe(ae)}),[ae]),(0,n.useEffect)((()=>{oe||"unmounted"!==ue||be()}),[oe,ue]);const fe="medium"===I?"4":"2",ge=Br("outer",fe,j),me=Br("inner",fe,j),be=()=>{q(""),H(""),te(-1)},$e=e=>{if(!oe)return e.stopPropagation(),e.preventDefault(),ie(!0);e.key in Zr&&(e.preventDefault(),e.stopPropagation(),e.key===Zr.ArrowUp?ne("up"===u?"next":"previous"):e.key===Zr.ArrowDown&&ne("up"===u?"previous":"next"),e.key===Zr.Enter&&((e=>{const t=Q[ee];t&&J(t,e),be()})(e),ie(!1)))},ve=e=>t=>{t.stopPropagation(),J(e,t),ie(!1)},ye=e=>{const t=Number(e.currentTarget.getAttribute("data-option-index"));isNaN(t)||re(t)};he(B,"click",(()=>ie(!1)),oe);const we=({option:e})=>e?n.createElement(n.Fragment,null,e.prefix&&n.createElement("div",null,e.prefix),e.node?e.node:e.label||e.value):null;return n.createElement(De,{"data-testid":"select",description:o,error:p,hideLabel:f,id:V,inline:g,label:m,labelSecondary:y,required:w,width:k},n.createElement("div",{style:{position:"relative"}},n.createElement(Cr,$(b({},$(b({},D),{"aria-controls":`listbox-${V}`,"aria-expanded":"true","aria-haspopup":"listbox","aria-invalid":!!p||void 0,"data-testid":"select-container",role:"combobox",onClick:()=>{G&&!oe&&ie(!0),G||ie(!oe)},onKeyDown:$e})),{$disabled:i,$size:I,id:`combo-${V}`,ref:B,tabIndex:x,onBlur:S,onFocus:P}),n.createElement(Pr,null,G&&ae?n.createElement(Or,{$padding:ge,autoCapitalize:"none",autoComplete:"off",autoFocus:!0,"data-testid":"select-input",placeholder:null==K?void 0:K.label,ref:M,size:de,spellCheck:"false",style:{flex:"1",height:"100%"},value:_,onChange:e=>{const t=e.currentTarget.value;q(t),H(t),te(-1)},onKeyDown:e=>$e(e)}):K?n.createElement(Tr,{$gap:me,$padding:ge,"data-testid":"selected"},n.createElement(we,{option:K})):d?n.createElement(Ar,{$padding:ge},d):null),n.createElement(zr,null,se?n.createElement(Lr,{$padding:ge,type:"button",onClick:e=>{e.stopPropagation(),q(""),H(""),te(-1)}},n.createElement($n,null)):n.createElement(Lr,{$padding:ge,type:"button"},n.createElement(Rr,{$direction:u,$disabled:i,$open:ae,onClick:()=>ie(!oe)}))),n.createElement(E,null,n.createElement("input",{"aria-hidden":!0,name:L,ref:N,tabIndex:-1,value:U,onChange:e=>{const t=e.target.value,r=null==T?void 0:T.find((e=>e.value===t));r&&(X(r.value),C&&C(e))},onFocus:()=>{var e;M.current?M.current.focus():null==(e=B.current)||e.focus()}}))),n.createElement(Ir,{$direction:u,$rows:A,$state:ue,id:`listbox-${V}`,role:"listbox",tabIndex:-1,onMouseLeave:()=>{re(-1)}},n.createElement(jr,{$direction:u,$rows:A},0===Q.length&&n.createElement(Dr,null,O),Q.map(((e,t)=>n.createElement(Fr,$(b({},{$selected:(null==e?void 0:e.value)===U,$disabled:e.disabled,$highlighted:t===ee,$gap:me}),{"data-option-index":t,key:e.value,role:"option",onClick:ve(e),onMouseOver:ye}),n.createElement(we,{option:e}))))))))}));_r.displayName="Select";const Hr=o.ZP.div((({theme:e,$error:t,$validated:r,$showDot:n,$disabled:i})=>o.iv`
    position: relative;
    background-color: ${e.colors.backgroundSecondary};
    border-radius: ${e.radii["2xLarge"]};
    border-width: ${e.space[.75]};
