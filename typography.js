module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-links': theme('colors.ens.500'),
      '--tw-prose-links-hover': theme('colors.ens.600'),
      '--tw-prose-links-underline': theme('colors.ens.500 / 0.3'),
      ...
      '--tw-prose-invert-links': theme('colors.ens.400'),
      '--tw-prose-invert-links-hover': theme('colors.ens.500'),
      '--tw-prose-invert-links-underline': theme('colors.ens.500 / 0.3'),
