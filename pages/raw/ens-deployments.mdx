...
To find out the contract address of each tld, check the "controller" address of the tld \(eg: [app.ens.domains/name/xyz](https://app.ens.domains/name/xyz) for `.xyz`)

![Screenshot](../public/assets/screenshot-2021-05-19-at-17.54.17.png)
...
For other contract addresses such as root, multisig, controller, public resolver, and so on, you can see their address under [app.ens.domains/name/ens.eth/subdomains](https://app.ens.domains/name/ens.eth/subdomains)
