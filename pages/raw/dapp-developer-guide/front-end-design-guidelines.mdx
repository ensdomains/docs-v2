...
![example of showing just the name and the visual checksum](../../public/assets/ensguidelines_01_onlydomain_2x.jpg)
...
![by clicking the name, this expanded pop-up appears showing the name with the full address](../../public/assets/ensguidelines_03_expanded1.jpg)
...
![example of names with the address visible at the same time](../../public/assets/ensguidelines_02_nameandaddress_2x.jpg)
...
![when resolving an input show both the ENS name and the Address together](../../public/assets/ensguidelines_02b_nameandaddressclear.jpg)
...
![decentralandUI Tooltip showing the full Address](../../public/assets/ensguidelines_03_expanded2simple_justatooltip2.jpg)
