...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
    <Button as="a" suffix={<ExternalLink />} size="small" variant="action" href="https://app.ens.domains" target="_blank">Go to ENS Manager</Button>
    <Button as="a" suffix={<ExternalLink />} size="small" variant="secondary" href="https://alpha.ens.domains" target="_blank">ENS Alpha Manager</Button>
</div>
...
<div className="gap-4 grid grid-cols-1 md:grid-cols-2 mt-4">
    {[
        ...
        <Link href={a[2]} key={a[2]}>
            <Button as="a" variant="secondary" href={a[2]}>
