...
export function Libraries() {
  return (
    <div className="xl:max-w-none">
      <div className="grid grid-cols-1 gap-x-16 gap-y-8 sm:grid-cols-2 2xl:grid-cols-3">
        {ensLibraries.map((library) => (
          <div key={library.name} className="not-prose">
            <Heading
              level={2}
                  ...
                  <span className="flex gap-1">
                    {library.tags
                      ...
                      .map((tag) => (
                        ...
                        >
                          <img src={tag.src.src} className="h-4 w-4" />
                        </div>
                      ))}
                  </span>
                </span>
