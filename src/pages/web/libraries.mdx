...
<VideoComponent src="https://v3x.space/ens-docs/libraries.mkv" />

There are many ways you can interface with the Ethereum smart contracts. {{ className: 'lead' }}

## Quickstart Kits

<span className="realtivetext-zinc-500"> (Frontend, React, Svelte, Vue, Astro) </span>
...
## Libraries <span className="text-zinc-500">All the languages...</span>
