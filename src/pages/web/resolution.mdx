...
The simplest thing you can do with ENS is to get the users Ethereum address. This is done by using the forward lookup method, which takes an ENS name and returns the address. You might use this to let users enter their ENS name instead of their address.
...
The standardization of multichain address were first introduced in [ENSIP-9](/ensips/ensip-9).
