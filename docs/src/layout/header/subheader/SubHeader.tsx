...
export const SubHeader = () => {
    ...
    return (
        <div className="border-b-ens-light-border dark:border-b-ens-dark-border bg-ens-light-background-primary dark:bg-ens-dark-background-primary fixed inset-x-0 top-16 z-10 border-b px-6 py-3">
