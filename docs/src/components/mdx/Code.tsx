...
> = ({ title, children, selectedIndex }) => {
    ...
    return (
        <div className="flex min-h-[calc(theme(spacing.12)+1px)] flex-wrap items-start gap-x-4 border-b-4 border-zinc-300 bg-neutral-50 px-4 dark:border-zinc-800 dark:bg-zinc-800">
            {title && (
